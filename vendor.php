<?php
  ...
  $all_categories = find_all('vendor')
?>
<?php
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="post" action="vendor.php">
                    ...
                    <button type="submit" name="add_cat" class="btn btn-primary">Add Vendor</button>
                </form>
            </div>
        </div>
    </div>
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo remove_junk(ucfirst($cat['vendor_name'])); ?></td>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="edit_vendor.php?id=<?php echo (int)$cat['id'];?>"
                                        class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                    <a href="delete_vendor.php?id=<?php echo (int)$cat['id'];?>"
